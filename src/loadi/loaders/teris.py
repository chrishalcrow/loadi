...
class TerisSession(BaseSession):
    ...
    def __init__(self, mouse, day, session_type, data_path="/run/user/1000/gvfs/smb-share:server=cmvm.datastore.ed.ac.uk,share=cmvm/sbms/groups/CDBS_SIDB_storage/NolanLab/ActiveProjects/Teris"):
        self.mouse = mouse
        self.day = day
